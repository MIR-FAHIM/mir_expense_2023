...
class ProjectExpenseListScreen extends StatefulWidget {
 String? project;
 ProjectExpenseListScreen({required this.project});
  @override
  State<ProjectExpenseListScreen> createState() => _ExpenseListScreenState();
}

class _ExpenseListScreenState extends State<ProjectExpenseListScreen> {
  ...
  Future getExpense() async {
    ...
    transactionList = querySnapshot.docs.where((element) => element["type"] == "expense" && element["project"] == widget.project &&  monthSelection ==
