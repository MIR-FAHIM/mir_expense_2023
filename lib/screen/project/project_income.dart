...
class ProjectIncomeListScreen extends StatefulWidget {
  String? project;
  ProjectIncomeListScreen({required this.project});

  @override
  State<ProjectIncomeListScreen> createState() => _IncomeListScreenState();
}

class _IncomeListScreenState extends State<ProjectIncomeListScreen> {
  ...
  Future getIncome() async {
    ...
    transactionList = querySnapshot.docs.where((element) => element["type"] == "income" && element["project"] == widget.project &&  monthSelection ==
