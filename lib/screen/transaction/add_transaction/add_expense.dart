...
import 'package:project_expense/repository/notification_repository.dart';
...
class AddExpense extends StatefulWidget {
  ...
  @override
  State<AddExpense> createState() => _SignUpScreenState();
}

class _SignUpScreenState extends State<AddExpense> {
                                    ...
                                    child: DropdownButton<String>(
                                      ...
                                      items: allData.map((value) {
                                        return DropdownMenuItem<String>(
                                          ...
                                          child: Text(value["cat_name"].toString()),
                                        );
                                      }).toList(),
                                    ),
                                  ));
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Center(
                            child:   provider.bangLang == true ? Text(
                              "ব্যয় যুক্ত করুন ", style: TextStyle(color: Colors.white),
                            ): Text(
                             'Add Expense',
                             style: TextStyle(color: Colors.white),
                                ),
